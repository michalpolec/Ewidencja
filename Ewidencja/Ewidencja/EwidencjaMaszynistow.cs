...
namespace Ewidencja
{
    public partial class EwidencjaMaszynistow : Form
    {
        ...
        private void firstExcel_Click(object sender, EventArgs e)
        {
            ...
            if (getIfLoadingCancel())
            {
                ...
                AllDriversAndTrains = LoadToListAllDrivers(2, 9, 10);
        ...
        private void secondExcel_Click(object sender, EventArgs e)
        {
            ...
            if (getIfLoadingCancel())
            {
                ...
                LoadExcelFile(filePath);
                AllDriversAndTrains.AddRange(LoadToListAllDrivers(2, 9, 10));
        ...
        private void SheetFormatting()
        {
            ...
            titleOfTable.Add("");
            titleOfTable.Add("Pojazdy");
            titleOfTable.Add("Maszynista 1");
            titleOfTable.Add("Wynik");
            titleOfTable.Add("Pojazdy");
            titleOfTable.Add("Maszynista 2");
            titleOfTable.Add("Wynik");
